...
APP_VERSION = "15.14-nonblocking-startup"
...
def ecom_process_display(master):
    ...
    unique_remarks = remark_series.drop_duplicates()
    task_map = {
        value: task_type_from_remark(value)
        for value in unique_remarks.tolist()
    }
...
st.caption("Build: v15.14 — Non-Blocking Startup + Fast Dashboard")
